# BA-Thesis-LCNC
This repository is used to share and distribute additional materials used during the creation of my Bachelor's Thesis.

## Available Files
* Review Protocol V5: Main Appendix of the thesis. Used to track changes in the process and intermediate results.
* Pilot Study Tables: Excel File containing Sheets 'Criteria Check Pilot Study', 'QGS Corpus', 'QGS Details', 'Database Selection', 'Exclusion Metrics'
  * Criteria Check Pilot Study: Filterable Table with all 40 papers from the QGS-Pool, checks for selection criteria, inclusion decision
  * QGS Corpus: All studies included in the QGS Pool
